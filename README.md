...
|---|---|---|
| Цена «от ...» | `от 450 руб` (CF3300) | 450.00; «от» отбрасываем, это неоднозначность «цена от» vs точная — задокументировано |
| Тысячные пробелы + запятая | `8 990,00` → 8990.00; `12 500.00` → 12500.00; `390,5` → 390.50 | убрать `руб/rub/р`, пробелы, `,`→`.`; на выходе всегда 2 знака после точки |
